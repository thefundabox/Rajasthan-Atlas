...
const DICT = {
  ...
  'Search (press / to focus)…': 'खोजें (/ दबाएँ)…',
  'Revise':                   'दोहराएँ',
  'Compare':                  'तुलना',
  'Statistics':               'आँकड़े',
  'Print':                    'छापें',
  ...
  'Revision Dashboard — study cards + concept chains (V)': 'दोहराव डैशबोर्ड — अध्ययन कार्ड और अवधारणा-श्रृंखलाएँ (V)',
  'Compare two features (X)': 'दो फ़ीचर की तुलना (X)',
  'Compare mode':             'तुलना मोड',
  'By the numbers — atlas statistics': 'आँकड़ों में — एटलस के आँकड़े',
  'Print / save as PDF':      'छापें / PDF में सहेजें',
  'Cycle theme (D)':          'थीम बदलें (D)',

  /* Layers popover */
  '☰  Layers':                '☰  लेयर',
  'Layers':                   'लेयर',
  'Layers, modes, and legend':'लेयर, मोड और लीजेंड',
  'Tick a dataset to show or hide it on the map.': 'नक़्शे पर दिखाने या छिपाने के लिए किसी डेटासेट को चुनें।',
  'Toggle visibility':         'दृश्यता बदलें',
